...
public class ToConnectServer {
    ...
    private String servidor = DataBase.LOCAL.getDesc();
     
    //private String servidor = "localhost";
   
    private String nomeDoBanco = DataBase.DATA_BASE.getDesc();
    private String usuario = DataBase.USER_SERVER.getDesc(); 
    private String senha = DataBase.PASSWORD_SERVER.getDesc();
    
    public ToConnectServer(){} 
    
    public ToConnectServer(String pServidor, String pNomeDoBanco, String pUsuario, String pSenha){
