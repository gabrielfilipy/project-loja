...
public class ProviderView extends javax.swing.JFrame {
    ...
    private ViewShowAlertDialog alert;
    ...
    public void add () { 
        if(tfName.getText().equals("")) { 
            alert = new ViewShowAlertDialog(this, rootPaneCheckingEnabled, "Required fields!", "Provider");
        }else{
            p.setName(tfName.getText());
            p.setAddress(tfAddres.getText());
            p.setEmail(tfEmail.getText());
            p.setNumber_telephone(tfTelephone.getText());
            if(c.save(p) > 0){
               dialog = new ViewShowSuccessDialog(this, true, "Save success.");
               clearFields ();
               LIST_PROVIDER();
            } 
        }
    ...
    public void update () {
        if(tfName.getText().equals("")) { 
            ...
            p.setNumber_telephone(tfTelephone.getText());
            if (c.update(p)) {
                dialog = new ViewShowSuccessDialog(this, true, "Update success.");
                LIST_PROVIDER();
            }
        }
    }
    ...
    private void jBEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEditActionPerformed
        ProviderListView v = new ProviderListView();
